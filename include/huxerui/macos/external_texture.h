...
/// A latest-frame macOS texture backed by immutable HuxerUI-owned Metal snapshots.
///
...
/// A latest-frame macOS ExternalTexture backed by immutable HuxerUI-owned Metal snapshots.
///
