...
View App() {
  ...
  return Column{
        ...
        Button("Open declarative dialog").OnClick([dialog_visible] {
          dialog_visible = true;
        }),
        Button("Open command dialog").OnClick([dialogs] {
          dialogs.Show(
              [](DialogContext dialog) {
                return CommandDialogCard(dialog);
              },
              DialogOptions{
        ...
        Dialog{
            ...
            .content = [dialog_visible] {
              return DeclarativeDialogCard(dialog_visible);
            },
            .dismiss_on_outside_press = true,
            .on_dismiss_request = [dialog_visible] {
