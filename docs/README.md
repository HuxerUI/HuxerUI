...
- [C++20 modules and mcpp](../skills/huxerui-app-development/references/cpp-modules-and-mcpp.md): `import huxerui;`, module units, and building with mcpp instead of CMake.
