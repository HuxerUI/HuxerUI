...
Linux additionally requires GTK 4.22 or later, Pango, Cairo, GIO, and libsoup 3 development packages discoverable through pkg-config.
Building the Linux OpenGL ExternalTexture example additionally requires libepoxy.
