...
| [Application Activation and Lifecycle Design](docs/design/application.md) | Startup input, subsequent activation, observable lifecycle state, and Runtime delivery |
