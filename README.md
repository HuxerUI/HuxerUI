...
| `example_platform_module` | Android, iOS, Linux, macOS, Windows, and Web typed platform services, plus Android `Bitmap` and Apple `CVPixelBuffer` ExternalTexture streams |
