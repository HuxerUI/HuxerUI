...
- Repeated tap, long press, drag, multi-pointer transform, and typed in-process drag-and-drop: [gestures-and-drag-drop.md](references/gestures-and-drag-drop.md)
