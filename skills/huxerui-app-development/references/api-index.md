...
| Platform integration | host adapter, typed platform values, payloads, modules, views, events, and root registration | [platform-modules.md](platform-modules.md), [platform-views.md](platform-views.md) | `platform_adapter.h`, `platform_registry.h`, platform registry headers |
