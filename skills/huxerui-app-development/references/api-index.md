...
| Paint | `Color`, `VisualFill`, `Canvas`, `PaintContext`, `StrokeStyle`, `DrawLine`, `UseTextMeasurer`, `Path`, `Path::ArcTo`, `ArcSize`, `ArcDirection`, gradients, images, vectors | [canvas-paint-and-images.md](canvas-paint-and-images.md) | `color.h`, `paint.h`, `text.h`, `vector.h` |
